    ...
    public class AppsLoader
    {
        ...
        public void Run()
        {
            ...
            if (implementingType != null)
            {
                ...
                (string, string) valuesOfMethod = GetValues();
                object[] parameters = new object[] { parsedChoice, valuesOfMethod.Item1, valuesOfMethod.Item2 };
        ...
        public static (string, string) GetValues()
        {
            string? Value1;
            string? Value2;
